...
public class TDSDeductionFragment extends Fragment {
    private View view;
    ...
    private void getLayoutsId() {
        ...
        pd.show();
        webView.setWebViewClient(new TDSDeductionFragment.MyBrowser());
        ...
        webView.loadUrl("http://tnssofts.com/ESP/LeaveForm/TDSDeductionWebView/"+empId);
    }
