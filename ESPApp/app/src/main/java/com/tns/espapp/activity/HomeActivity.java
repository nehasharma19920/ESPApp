...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tv_taxiform, tv_userhomeid, tv_location_history,getTv_taxiform_record ,tv_toolbar, tvpersomalinfo,tv_feedback, tv_feedback_history,tv_locationmap,tv_notification,tv_taxiform_home_fragment,tv_checklist, tv_setting;
    private  LinearLayout linear_taxiform,mDrawerPane, linear_checklist;
    private Toast toast;
...
/*
        ...
        if (v == tv_checklist) {
         ...
         //   getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout_home_frag,  CheckListFragment.newInstance_CheckListFragment(1,"Form")).commit();
           // mDrawerLayout.closeDrawer(mDrawerPane);
