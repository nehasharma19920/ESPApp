...
public class InfoBullteinFragment extends Fragment {
    private View view;
    ...
    private void getLayoutsId() {
        ...
        pd.show();
        webView.setWebViewClient(new InfoBullteinFragment.MyBrowser());
        ...
        webView.loadUrl("http://tnssofts.com/ESP/info/BulletinInfoWebView/"+empId);
    }
