...
public class LeaveTransactionFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.leave_transaction_fragment, container, false);
        getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        pd.show();
        webView.setWebViewClient(new LeaveTransactionFragment.MyBrowser());
        ...
        webView.loadUrl("http://tnssofts.com/ESP/leave/LeaveTransactionWebView/"+empId);
    }
