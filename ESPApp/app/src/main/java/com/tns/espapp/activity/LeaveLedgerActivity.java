...
public class LeaveLedgerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leave_ledger);
        getLayoutsId();
    ...
    private void getLayoutsId() {
        ...
        webView.loadUrl("http://tnssofts.com/ESP/leave/leaveledgerWebView/" + empId);
    }
